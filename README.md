...
1. Follow the instructions at http://cygwin.com/install.html. You will run an executable called setup.exe which will guide you through the installation. You will eventually arrive at a screen where you can select the packages you want to install. Be sure to install Python, MySql, virt-manager and openssh.
...
```
4. For virtualization, Install XMing XServer and setup Putty for ssh connections.

5. Virt-manager can call ssh to make the connection to KVM Server and would be able to run virsh and send comamnds to it. 

6. Now Follow the steps similar to linux installation in Cygwin terminal.
